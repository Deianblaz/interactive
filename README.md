...
Puedes descargar la ultima version desde este enlace: [Interactive v1.14.0](https://github.com/Deianblaz/InteractiveApp/releases/download/v1.14.0/interactive-1.14.0-setup.exe)

### Actualizaciones:
- `Version 1.14.0 (12/05/2025)`
  - Arreglado bug en la lista de audios.

- `Version 1.13.0 (30/04/2025)`
  - Añadido conexión a OBS.

- `Version 1.12.0 (23/04/2025)`
  - Mejora en la Base de datos.
  - Optimización en el código.
  - Mejoras para futuras integraciones de Mini-Juegos.
  - Se agregaron permisos para descarga de plugins de Mini-Juegos.

- `Version 1.11.0 (14/04/2025)`
  - Mejora en la reproduccion de Audios y Multimedia local.

- `Version 1.10.0 (09/04/2025)`
  - Mejoras en Minijuegos, instalaciones rápidas y fáciles.
  - Mejora en las actualizaciones e instalación de la aplicación.
...
- `Version 1.8.3 (20/03/2025)`
  - Corrección bug keystrokes.

- `Version 1.8.2 (20/03/2025)`
  - Añadido AutoIt para mejoras en la ejecución de Keystrokes.

- `Version 1.8.1 (12/03/2025)`
  - Mejoras de librerias.
